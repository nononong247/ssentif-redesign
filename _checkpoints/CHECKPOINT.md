...
🔴 **`_checkpoints/build_product.py`는 stale.** 출력 대상이던 product-new.html은 2026-07-30 product.html로 승격되며 삭제됨. **재실행 금지** — 실행하면 캡처 9장이 CSS 목업으로 되돌아간 별도 파일이 생긴다. 구조 변경은 product.html 직접 수정 또는 스크립트에 이미지 삽입부터 반영할 것.
...
### (구) v2 — 히어로카드 + 컴팩트그리드 (커밋 `6b69914`, git 히스토리로만 존재)

### ✅ v3 배포 완료 (2026-07-30) — 구 product-new.html이 product.html로 승격
